"""
In-container monitor client for TranslateGemma.

This monitor runs inside the vLLM container and reports the upstream payload
based on the local server process and vLLM's fixed /health endpoint.
"""
...
logger = logging.getLogger("tg_monitor_client")
...
SERVICE_NAME = os.getenv("MONITOR_SERVICE_NAME", "TranslateGemma")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Embedded TranslateGemma monitor client")
